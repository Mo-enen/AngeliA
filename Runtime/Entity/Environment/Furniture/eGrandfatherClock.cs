...
namespace AngeliaGame {
	public class eGrandfatherClockA : eGrandfatherClock { }
	public class eGrandfatherClockB : eGrandfatherClock { }
	public abstract class eGrandfatherClock : Furniture, ICombustible {
