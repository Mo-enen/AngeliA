...
namespace Yaya {
	public partial class CharacterMovement : ISerializationCallbackReceiver {
		...
		public BuffInt RunAccumulation { get; private set; } = new();
		...
		public BuffBool SlideAvailable { get; private set; } = new();
		public BuffBool SlideOnAllBlocks { get; private set; } = new();
		public BuffInt SlideDropSpeed { get; private set; } = new();
		public BuffInt SlideJumpCountRecover { get; private set; } = new();
...
#pragma warning disable
		...
		// Run
		[SerializeField] int _RunAccumulation = 48;
