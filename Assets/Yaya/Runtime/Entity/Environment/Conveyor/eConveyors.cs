...
namespace Yaya {
	...
	// Wood
	public class eConveyorWoodLeft : eConveryorWood { protected override int MoveSpeed => -12; }
	public class eConveyorWoodRight : eConveryorWood { protected override int MoveSpeed => 12; }
	public abstract class eConveryorWood : eConveyor {
	...
	// Iron
	public class eConveyorIronLeft : eConveryorIron { protected override int MoveSpeed => -24; }
	public class eConveyorIronRight : eConveryorIron { protected override int MoveSpeed => 24; }
	public abstract class eConveryorIron : eConveyor {
