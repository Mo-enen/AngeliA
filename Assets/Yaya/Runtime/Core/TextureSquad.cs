...
namespace Yaya {
	public class TextureSquad {
		...
		public TextureSquad (MapChannel channel, int worldSize = 7) {
			WorldSize = worldSize;
			...
			SquadRoot.localPosition = Vector3.zero;
			SquadRoot.localRotation = Quaternion.identity;
