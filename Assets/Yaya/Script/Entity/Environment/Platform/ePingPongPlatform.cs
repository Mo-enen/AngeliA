...
namespace Yaya {
	...
	[EntityAttribute.EntityBounds(-Const.CELL_SIZE * 5 / 2, 0, Const.CELL_SIZE * 5, Const.CELL_SIZE)]
	...
	[EntityAttribute.EntityBounds(0, -Const.CELL_SIZE * 5 / 2, Const.CELL_SIZE, Const.CELL_SIZE * 5)]
