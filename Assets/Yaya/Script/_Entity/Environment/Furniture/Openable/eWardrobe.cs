...
namespace Yaya {
	public class eWardrobe : eOpenableFurniture {
		...
		protected override int ArtworkCode_LeftDown => Open ? CODE_OPEN : CODE;
		protected override int ArtworkCode_Mid => Open ? CODE_OPEN : CODE;
		protected override int ArtworkCode_RightUp => Open ? CODE_OPEN : CODE;
