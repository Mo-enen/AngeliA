...
namespace AngeliaGame {
	...
	public class eFootmanA : NPC {
		...
		private static readonly int SHOULDER_CODE = "FootmanA.Armor.Shoulder".AngeHash();
	...
	public class eFootmanB : NPC {
		...
		private static readonly int SHOULDER_CODE = "FootmanB.Armor.Shoulder".AngeHash();
	...
	public class eFootmanC : NPC {
		...
		private static readonly int SHOULDER_CODE = "FootmanC.Armor.Shoulder".AngeHash();
	...
	public class eFootmanD : NPC {
		...
		private static readonly int SHOULDER_CODE = "FootmanD.Armor.Shoulder".AngeHash();
	...
	public class eFootmanE : NPC {
		...
		private static readonly int SHOULDER_CODE = "FootmanE.Armor.Shoulder".AngeHash();
	...
	public class eFootmanF : NPC {
		...
		private static readonly int SHOULDER_CODE = "FootmanF.Armor.Shoulder".AngeHash();
	...
	public class eFootmanG : NPC {
		...
		private static readonly int SHOULDER_CODE = "FootmanG.Armor.Shoulder".AngeHash();
	...
	public class eFootmanH : NPC {
		...
		private static readonly int SHOULDER_CODE = "FootmanH.Armor.Shoulder".AngeHash();
