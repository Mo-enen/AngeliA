...
public abstract class PlayableCharacter : Character, IActionTarget, IPlayable {
	...
	protected override CharacterAttackness CreateNativeAttackness () => new PlayableCharacterAttackness(this);
