...
namespace AngeliaGame {
	public sealed partial class GameForUnity {
		...
		private class RenderingTextLayerUnity : RenderingLayerUnity {
		...
		private RenderingTextLayerUnity[] RenderingTextLayers = new RenderingTextLayerUnity[0];
		...
		private void BeforeGameInitialize_Rendering () {
			...
			RenderingTextLayers = new RenderingTextLayerUnity[Fonts.Length];
			SheetTexture = LoadSheetTextureFromDisk() as Texture2D;
		}


		[OnGameUpdatePauseless(4095)]
		public static void OnGameUpdatePauseless_Rendering () {
		...
		protected override void OnLayerUpdate (int layerIndex, bool isTextLayer, Cell[] cells, ref int prevCellCount) {
		...
		private static RenderingLayerUnity CreateRenderingLayer (Transform root, Material material, string name, int sortingOrder, int renderCapacity, bool textLayer) {
			...
			// Create Layer
			var layer = textLayer ? new RenderingTextLayerUnity() : new RenderingLayerUnity();
