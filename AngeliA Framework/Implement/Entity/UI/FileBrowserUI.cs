...
public sealed class FileBrowserUI : EntityUI, IWindowEntityUI {
	...
	public override void UpdateUI () {
		...
		// Lines
		CellRenderer.Draw(BuiltInIcon.SOFT_LINE_H, new IRect(X, Y + Height - navBarHeight - lineSize / 2, Width, lineSize), Color32.GREY_20, z: 1);
		CellRenderer.Draw(BuiltInIcon.SOFT_LINE_H, new IRect(X, Y + controlPanelHeight - lineSize / 2, Width, lineSize), Color32.GREY_20, z: 1);
		CellRenderer.Draw(BuiltInIcon.SOFT_LINE_V, new IRect(X + favPanelWidth - lineSize / 2, Y + controlPanelHeight, lineSize, Height - controlPanelHeight - navBarHeight), Color32.GREY_20, z: 1);
