...
public static class Sky {
	...
	public static ColorGradient GradientTop { get; set; } = new ColorGradient(
		new ColorGradient.Data(new Color32(0, 41, 75), 0f / 4f),
		new ColorGradient.Data(new Color32(0, 75, 128), 1f / 4f),
		new ColorGradient.Data(new Color32(21, 110, 181), 2f / 4f),
		new ColorGradient.Data(new Color32(0, 75, 128), 3f / 4f),
		new ColorGradient.Data(new Color32(0, 41, 75), 4f / 4f)
	);
	...
	public static ColorGradient SunlightTint { get; set; } = new ColorGradient(
		...
		new ColorGradient.Data(new Color32(255, 250, 240, 255), 0.5f),
