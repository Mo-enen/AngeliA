...
namespace AngeliaFramework {
	...
	public class iArmorIron : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iIngotGold), typeof(iArmorIron), 1)]
	public class iArmorGold : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iFabric), typeof(iArmorIron), 1)]
	public class iArmorBrave : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iSkull), typeof(iSkull), typeof(iArmorWood), 1)]
	public class iArmorSkull : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iArmorIron), typeof(iIngotIron), 1)]
	public class iChainMail : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iClay), typeof(iArmorWood), 1)]
	public class iArmorClay : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iFabric), typeof(iFabric), typeof(iFabric), typeof(iFabric), 1)]
	public class iVelvetDress : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iRope), typeof(iFabric), typeof(iFabric), typeof(iFabric), 1)]
	public class iCloak : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iArmorIron), typeof(iArmorIron), 1)]
	public class iArmorKnight : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iCloak), typeof(iRuneCube), 1)]
	public class iMageRobe : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iLeather), typeof(iLeather), typeof(iLeather), typeof(iArmorWood), 1)]
	public class iArmorLeather : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iBolt), typeof(iBolt), typeof(iBolt), typeof(iArmorWood), 1)]
	public class iArmorStudded : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iEar), typeof(iNose), typeof(iFist), typeof(iCloak), 1)]
	public class iPractitionerRobe : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }

	[EntityAttribute.ItemCombination(typeof(iIngotGold), typeof(iArmorStudded), 1)]
	public class iArmorPaladin : Armor { public override EquipmentType EquipmentType => EquipmentType.BodySuit; }
