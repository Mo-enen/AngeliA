...
namespace AngeliaFramework {
	public static partial class Util {
		...
		public static int DistanceInt (Vector2Int a, Vector2Int b) {
			int x = a.x - b.x;
			int y = a.y - b.y;
		...
		public static float PointLine_Distance (Vector2 point, Vector2 a, Vector2 b) {
		...
		public static bool Intersect_SegmentSegment (Vector2Int a0, Vector2Int a1, Vector2Int b0, Vector2Int b1, out Vector2Int intersection) {
		...
		public static int Intersect_SegmentRect (Vector2Int a0, Vector2Int a1, RectInt rect, out Vector2Int intersection0, out Vector2Int intersection1) => Intersect_SegmentRect(a0, a1, rect, out intersection0, out intersection1, out _, out _);


		public static int Intersect_SegmentRect (Vector2Int a0, Vector2Int a1, RectInt rect, out Vector2Int intersection0, out Vector2Int intersection1, out Vector2Int normalDirection0, out Vector2Int normalDirection1) {
			...
			if (Intersect_SegmentSegment(
				...
				intersection0 = inter;
				normalDirection0 = Vector2Int.up;
				interCount++;
			}
			...
			if (Intersect_SegmentSegment(
				...
				if (interCount == 0) {
					intersection0 = inter;
					normalDirection0 = Vector2Int.down;
					interCount++;
				} else {
					intersection1 = inter;
					normalDirection1 = Vector2Int.down;
					return 2;
				}
			}
			...
			if (Intersect_SegmentSegment(
				...
				if (interCount == 0) {
					intersection0 = inter;
					normalDirection0 = Vector2Int.left;
					interCount++;
				} else {
					intersection1 = inter;
					normalDirection1 = Vector2Int.left;
					return 2;
				}
			}
			...
			if (Intersect_SegmentSegment(
				...
				if (interCount == 0) {
					intersection0 = inter;
					normalDirection0 = Vector2Int.right;
					interCount++;
				} else {
					intersection1 = inter;
					normalDirection1 = Vector2Int.right;
					return 2;
				}
			}
		...
		// Bit
		public static (char a, char b) IntToChar2 (int i) => ((char)(i >> 16), (char)i);
