...
namespace HololiaGame {
	public partial class PlayerCustomizerHololia {
		...
		private static string[] _BodyPart_Faces = {
			...
			"#EN Myth",     nameof(CalliopeFace), nameof(KiaraFace), nameof(InaFace), nameof(InaArtistFace), nameof(GuraFace), nameof(AmeFace),
		...
		private static string[] _BodyPart_Hairs = {
			...
			"#EN Myth",     nameof(CalliopeHair), nameof(KiaraHair), nameof(InaHair), nameof(InaCasualHair), nameof(InaArtistHair), nameof(InaDressHair), nameof(InaKimonoHair), nameof(GuraHair), nameof(AmeHair),
		...
		private static string[] _Suit_Heads = {
			...
			nameof(InaHeadSuit), nameof(InaArtistHeadSuit), nameof(InaDressHeadSuit), nameof(AmeHeadSuit), nameof(IRySHeadSuit), nameof(MumeiHeadSuit), nameof(SanaHeadSuit),
		...
		private static string[] _Suit_BodyShoulderArmArms = {
			...
			"#EN Myth",     nameof(CalliopeBodySuit), nameof(KiaraBodySuit), nameof(InaBodySuit), nameof(InaCasualBodySuit),nameof(InaArtistBodySuit), nameof(InaDressBodySuit), nameof(InaKimonoBodySuit), nameof(GuraBodySuit), nameof(AmeBodySuit),
		...
		private static string[] _Suit_HipSkirtLegLegs = {
			...
			"#EN Myth",     nameof(CalliopeHipSuit), nameof(KiaraHipSuit), nameof(InaHipSuit), nameof(InaCasualHipSuit), nameof(InaArtistHipSuit), nameof(InaDressHipSuit), nameof(InaKimonoHipSuit), nameof(GuraHipSuit), nameof(AmeHipSuit),
		...
		private static string[] _Suit_Foots = {
			...
			"#EN Myth",     nameof(CalliopeFootSuit), nameof(KiaraFootSuit), nameof(InaFootSuit), nameof(InaCasualFootSuit), nameof(InaArtistFootSuit), nameof(InaDressFootSuit), nameof(InaKimonoFootSuit), nameof(GuraFootSuit), nameof(AmeFootSuit),
		...
		private static string[] _Suit_Hands = {
			...
			nameof(InaHandSuit),
			nameof(InaDressHandSuit),
			nameof(InaKimonoHandSuit),
